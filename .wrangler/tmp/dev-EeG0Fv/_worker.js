...
// .wrangler/tmp/bundle-JkBbbK/checked-fetch.js
...
__name(replaceInUri, "replaceInUri");
...
__name(replaceVmess, "replaceVmess");
...
__name(replaceTrojan, "replaceTrojan");
...
__name(replaceHysteria, "replaceHysteria");
...
__name(replaceYAML, "replaceYAML");
...
__name(urlSafeBase64Decode, "urlSafeBase64Decode");
function generateRandomStr(len) {
  return Math.random().toString(36).substring(2, len);
}
__name(generateRandomStr, "generateRandomStr");
...
__name(generateRandomUUID, "generateRandomUUID");
...
// .wrangler/tmp/bundle-JkBbbK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JkBbbK/middleware-loader.entry.ts
